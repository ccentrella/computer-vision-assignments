...
# File location
file_path = f'D:\\Keras\\Logs\\AlexNet2\\{time.strftime("%Y-%m-%d-%H%M%S")}\\'
...
batch_size = 256
epochs = 60
learning_rate = ExponentialDecay(initial_learning_rate=0.001, decay_steps=500,
...
callbacks=[checkpointer, earlystopping], validation_data=(x_test, y_test))
