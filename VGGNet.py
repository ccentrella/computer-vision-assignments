...
file_path = f'D:\\Keras\\Logs\\VGGNet\\{time.strftime("%Y-%m-%d-%H%M%S")}\\'
...
#   C2
model.add(Conv2D(filters=base_filter_count, kernel_size=(3,3), padding='same', kernel_initializer=GlorotNormal(), kernel_regularizer=L2(0.0005)))
model.add(ReLU())
model.add(MaxPooling2D(pool_size=(2,2), strides=(2,2)))

#   C3
model.add(Conv2D(filters=2*base_filter_count, kernel_size=(3,3), padding='same', kernel_initializer=GlorotNormal(), kernel_regularizer=L2(0.0005)))
model.add(ReLU())
...
#   C5
model.add(Conv2D(filters=4*base_filter_count, kernel_size=(3,3), padding='same', kernel_initializer=GlorotNormal(), kernel_regularizer=L2(0.0005)))
model.add(ReLU())
...
#   C8
model.add(Conv2D(filters=8*base_filter_count, kernel_size=(3,3), padding='same', kernel_initializer=GlorotNormal(), kernel_regularizer=L2(0.0005)))
model.add(ReLU())
